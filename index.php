    ...
    <div id="gameModal" class="modal">
        <div class="modal-content">
            ...
            <form id="gameForm" class="game-form">
                ...
                <div class="rounds-section">
                    <div class="rounds-header">
                        ...
                        <div class="rounds-controls">
                            <button type="button" id="addRoundBtn" class="btn btn-outline">+ Add Round</button>
                            <span class="rounds-info">Add up to 3 rounds (2 wins needed)</span>
                        </div>
                    </div>
                ...
                <div class="form-actions">
                    <button type="button" id="cancelGame" class="btn btn-secondary">Cancel</button>
